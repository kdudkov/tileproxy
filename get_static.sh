...
# bootstrap
curl https://cdn.jsdelivr.net/npm/bootstrap@5/dist/css/bootstrap.min.css -o $d/css/bootstrap.min.css
curl https://cdn.jsdelivr.net/npm/bootstrap@5/dist/js/bootstrap.bundle.min.js -o $d/js/bootstrap.bundle.min.js
